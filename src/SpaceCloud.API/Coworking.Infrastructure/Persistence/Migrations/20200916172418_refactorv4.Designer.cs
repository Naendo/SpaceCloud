...
namespace Coworking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20200916172418_refactorv4")]
    partial class refactorv4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Coworking.Domain.Entities.Desk", b =>
                {
                    ...
                    b.Property<int>("AvailableProductAmount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Coworking.Domain.Entities.Company", b =>
                {
                    b.HasOne("Coworking.Domain.Entities.User", "Owner")
                        .WithOne("OwnesCompany")
                        .HasForeignKey("Coworking.Domain.Entities.Company", "OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Coworking.Domain.Entities.Order", b =>
                {
                    b.HasOne("Coworking.Domain.Entities.Invoice", "Invoice")
                        .WithOne("Order")
                        .HasForeignKey("Coworking.Domain.Entities.Order", "OrderId")
